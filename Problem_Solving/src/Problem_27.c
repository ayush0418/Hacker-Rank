...
DoublyLinkedListNode* sortedInsert(DoublyLinkedListNode* llist, int data) {
    struct DoublyLinkedListNode *s = (struct DoublyLinkedListNode *)malloc(sizeof(DoublyLinkedListNode));
    struct DoublyLinkedListNode *p = llist;
    struct DoublyLinkedListNode *q = llist->next;
    s->data = data;
